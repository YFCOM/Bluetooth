	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == 1) {
				...
				Bundle bundle = msg.getData();
				String res = bundle.getString("contentRead");
				String message = bundle.getString("readMessage");
				...
				try {
					...
					if (jsonObject.has("trans_result")) {
						...
						if (jsonObjectR.has("dst")) {
							...
							mConversationArrayAdapter.add(mConnectedDeviceName + ":  "+jsonObjectR.getString("dst")+"\n"
									+ message);
						}
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						try {
							...
							Message message = new Message();
							Bundle bundle = new Bundle();
							bundle.putString("contentRead", res);
							bundle.putString("readMessage", readMessage);
							message.setData(bundle);
							message.what = 2;
							handler.sendMessage(message);
						} catch (ClientProtocolException e) {
